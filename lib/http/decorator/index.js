...
exports = module.exports = function decorate(http, options) {
  options = options || {};
  ...
  koa.listen = (port, cb, options) => {
    ...
    options = options || {};
    var koaCallback = koa.callback();

    var oldCallback = koaCallback;

    var server = http2.createServer(options.server);
