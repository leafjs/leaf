    ...
    try {
      yield(new Promise(function(resolve, reject) {
        let update = function() {
          ...
          leaf.controllers = {};
          glob(pathModule.resolve(leaf.basepath, "./app/Http/Controllers/**/*.js"), function(er, files) {
            if (er) {
              return reject(er);
            }
            for (let f of files) {
              ...
              new leaf.controllers[name](leaf, debug([leaf._config.name, "controller", name]));
        ...
        if (leaf.env !== "production") {
          fs.watch(pathModule.resolve(leaf.basepath, "./app/Http/Controllers/"), {
            recursive: true
          }, function() {
